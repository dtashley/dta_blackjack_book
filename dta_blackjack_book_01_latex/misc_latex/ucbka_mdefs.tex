...
\newcommand{\vworkrealsetnonneg}{{\mathbb{R}^*_+}}
%
%%Sets of integers.
\newcommand{\vworkintset}{{\mathbb{Z}}}
\newcommand{\vworkintsetnonneg}{{\mathbb{Z}^*_+}}
\newcommand{\vworkintsetpos}{{\mathbb{Z}_+}}
%
%%Sets of rational numbers.
\newcommand{\vworkratset}{{\mathbb{Q}}}
\newcommand{\vworkratsetnonneg}{{\mathbb{Q}^*_+}}
%
